...
export const words: WordType[] = [
  ...
  { word: "おはよう", meaning: "Good morning", genre: "daily", language: "JP" },
  {
    word: "こんにちは",
  ...
  { word: "ありがとう", meaning: "Thank you", genre: "formal", language: "JP" },
  {
    word: "すみません",
  ...
  { word: "会議", meaning: "Meeting", genre: "business", language: "JP" },
  {
    word: "プロジェクト",
    meaning: "Project",
    genre: "business",
  ...
  { word: "社員", meaning: "Employee", genre: "business", language: "JP" },
  {
    word: "お疲れ様でした",
  ...
  { word: "残業", meaning: "Overtime work", genre: "business", language: "JP" },
